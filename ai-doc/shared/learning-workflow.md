...
2. Classify task type using the loading matrix in `shared/doc-skill-map.md` (the single authoritative routing table).
...
6. For UI behavior changes, always collect browser pre/post evidence (see `shared/engineering-workflow.md` Evidence standard).
7. Before finishing:
