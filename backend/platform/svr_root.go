...
func (m *webMgr) initSvrRoot(r *gin.Engine) {
	...
	r.POST("/misc/money/batch/create", m.moneyBatchCreate)
	r.POST("/misc/money/batch/get", m.moneyBatchGet)
	r.POST("/misc/money/batch/update", m.moneyBatchUpdate)
	r.POST("/misc/money/batch/compute", m.moneyBatchCompute)
	r.POST("/misc/money/batch/confirm", m.moneyBatchConfirm)
	r.POST("/misc/money/batch/list", m.moneyBatchList)
