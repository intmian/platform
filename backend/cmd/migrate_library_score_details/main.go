...
func main() {
	...
	rollback := flag.Bool("rollback", false, "restore Task.Note and remove migrated score details")
	backup := flag.String("backup", "library-score-detail-migration-backup.jsonl", "backup JSONL path")
