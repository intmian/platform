...
export function sendCreateTool(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/createTool', req).then(callback)
}

export function sendUpdateTool(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/updateTool', req).then(callback)
}

export function sendGetTools(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/getToolIds', req).then(callback)
}

export function sendGetToolScript(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/getToolScript', req).then(callback)
}

export function sendCreateEnv(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/createEnv', req).then(callback)
}

export function sendGetEnvs(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/getEnvs', req).then(callback)
}

export function sendGetEnv(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/getEnv', req).then(callback)
}

export function sendGetFile(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/getFile', req).then(callback)
}

export function sendSetFile(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/setFile', req).then(callback)
}

export function sendSetEnv(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/setEnv', req).then(callback)
}

export function sendRunEnv(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/runEnv', req).then(callback)
}

export function sendGetTasks(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/getTasks', req).then(callback)
}

export function sendGetTask(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/getTask', req).then(callback)
}

export function sendStopTask(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/stopTask', req).then(callback)
}

export function sendTaskInput(req, callback) {
    UniPost(config.api_base_url + '/services/cmd/taskInput', req).then(callback)
}
